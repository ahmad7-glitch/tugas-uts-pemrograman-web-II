...
<a href="./add.php"><button type='submit' class='add-button' onclick="this.classList.add('clicked')">Tambah Data Dosen</button></a>
...
echo "<table>";
echo "<tr><th>ID</th><th>Nama</th><th>NIDN</th><th>Jenjang Pendidikan</th><th>Aksi</th></tr>";
